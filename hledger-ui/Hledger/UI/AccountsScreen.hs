  ...
  case mode of
    ...
    Normal ->
      case ev of
        ...
        VtyEvent (EvKey (KChar 'C') []) -> scrollTop >> (continue $ regenerateScreens j d $ toggleUncleared ui)
        VtyEvent (EvKey (KChar 'p') []) -> scrollTop >> (continue $ regenerateScreens j d $ togglePending ui)
        VtyEvent (EvKey (KChar 'P') []) -> scrollTop >> (continue $ regenerateScreens j d $ toggleNotPending ui)
        VtyEvent (EvKey (KChar 'u') []) -> scrollTop >> (continue $ regenerateScreens j d $ toggleUnmarked ui)
        VtyEvent (EvKey (KChar 'U') []) -> scrollTop >> (continue $ regenerateScreens j d $ toggleMarked ui)
